...
Megon is under active development and ships frequently. Security fixes are
applied to the latest released version only. Please make sure you are running
...
- **GitHub Security Advisories** — use the
  [Report a vulnerability](https://github.com/MegonLabs/megon/security/advisories/new)
...
Thank you for helping keep Megon and its users safe.
