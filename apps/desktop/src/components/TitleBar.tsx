...
export function TitleBar() {
  ...
  return (
    <header
      class="megon-titlebar h-10 shrink-0 bg-background-base relative overflow-hidden flex flex-row"
      style={{
    ...
    >
      <div class="grid h-full min-h-full w-full grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center">
        ...
        >
          ...
          <div id="megon-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" style={{ "-webkit-app-region": "no-drag" }} />
        </div>

        <div class="min-w-0 flex items-center justify-center pointer-events-none">
          <div id="megon-titlebar-center" class="pointer-events-auto min-w-0 flex justify-center w-fit max-w-full" />
        </div>
        ...
        >
          <div id="megon-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" style={{ "-webkit-app-region": "no-drag" }} />
          <Show when={linux()}>
