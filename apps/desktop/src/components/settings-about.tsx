...
export function SettingsAbout() {
  ...
  const [appName, setAppName] = createSignal("Megon")
    ...
    <div class="space-y-6 max-w-3xl">
      ...
      <div class="rounded-xl border border-border/80 bg-card/40 p-5 backdrop-blur-xs">
        <p class="text-sm text-muted-foreground">
          Copyright © 2026 Megon. Built by <a href="https://niloy.co" target="_blank" rel="noopener noreferrer" class="text-foreground hover:underline">Niloy</a>. All rights reserved.
        </p>
      </div>
    </div>
  )
