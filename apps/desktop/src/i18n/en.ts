export const dict = {
  ...
  "dialog.provider.megon.tagline": "Reliable optimized models",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Megon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Megon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Megon.",
  ...
  "provider.anthropicCompatible.description": "Connect a provider that supports the Anthropic Messages API. Megon will send the API key as x-api-key and use the Anthropic request format.",
  ...
  "dialog.plugins.empty": "Plugins configured in Megon.json",
  ...
  "dialog.server.description": "Switch which Megon server this app connects to.",
  ...
  "toast.update.description": "A new version of Megon ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Megon team",
  ...
  "error.chain.checkConfig": "Check your config (megon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Megon does not support MCP authentication yet.',
  ...
  "session.tab.allFiles": "All Files",
  ...
  "sidebar.gettingStarted.line1": "Megon includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Megon Desktop",
  ...
  "settings.desktop.wsl.description": "Run The Megon server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Megon",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Megon looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Megon follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Megon is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Megon launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Megon.",
