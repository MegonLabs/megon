...
Practical reference for new and migrated Effect code in `packages/megon`.
...
export namespace Foo {
  ...
  export class Service extends Context.Service<Service, Interface>()("@megon/Foo") {}
...
Tool tests should use the existing Effect helpers in `packages/megon/test/lib/effect.ts`:
