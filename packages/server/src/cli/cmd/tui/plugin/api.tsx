...
import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@megon/plugin/tui"
...
import { type OpencodeClient } from "@megon/sdk/v2"
...
export function createTuiApi(input: Input): TuiPluginApi {
  ...
  return {
    ...
    command: {
      register(cb) {
        return input.command.register(() => cb() as any)
      },
      trigger(value) {
