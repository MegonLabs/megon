...
const PROMPT_CREATE_SKILLS = [
  "Create new megon skill from user request.",
  "",
  "Request:",
  "$ARGUMENTS",
  "",
...
const PROMPT_REMOVE_SKILL = [
  ...
  "- Delete skill folder safely from skills/<slug>/ or .megon skill paths in workspace.",
  ...
  export class Service extends Context.Service<Service, Interface>()("@megon/Command") {}
