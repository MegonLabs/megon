...
export namespace ConfigPaths {
  /** Project-level config folder names. */
  export const PROJECT_DIRS = [".megon"]

  /** Config file basenames in merge order. */
  export const CONFIG_NAMES = ["megon"]
  ...
  export async function directories(directory: string, worktree: string) {
    return [
      Global.Path.config,
      ...(!Flag.MEGON_DISABLE_PROJECT_CONFIG
      ...
      ...(Flag.MEGON_CONFIG_DIR ? [Flag.MEGON_CONFIG_DIR] : []),
    ]
  }
