...
const HTML_SUCCESS = `<!doctype html><html><head><title>Cline Authorization Successful</title></head><body><h1>Authorization Successful</h1><p>You can close this window and return to megon.</p><script>setTimeout(() => window.close(), 2000)</script></body></html>`
