...
async function streamTokensIncremental(
  ...
  const result = streamText({
    ...
    headers: {
      ...
      "User-Agent": `megon/${Installation.VERSION}`,
      ...input.model.headers,
    },
  ...
  return new Response(
    new ReadableStream({
      ...
      cancel() {
        ...
        SessionPrompt.cancel(sessionID as SessionID).catch(() => {
  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all megon sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific megon session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new megon session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      async (c) => {
        ...
        return createSSEStream(sessionID, async (controller: ReadableStreamDirectController) => {
          ...
          await streamAIResponse(sessionID as SessionID, controller, encoder)
        })
      },
    )
    ...
    .post(
      ...
      async (c) => {
        ...
        return createOptimizedStream(async function* (controller: ReadableStreamDirectController) {
          ...
          let isActive = true
          const unsubscribe = Bus.subscribe("*" as any, (event) => {
            if (!isActive) return
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Remove messages that were marked for revert, cleaning up the session state.",
