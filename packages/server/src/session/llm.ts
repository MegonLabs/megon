...
export namespace LLM {
  ...
  export class Service extends Context.Service<Service, Interface>()("@megon/LLM") {}
  ...
  export async function stream(input: StreamRequest) {
    ...
    // from the workflow service are executed via megon's tool system
    ...
    return streamText({
      ...
      abortSignal: input.abort,
      headers: {
        ...(input.model.providerID.startsWith("megon")
          ? {
              "x-megon-project": Instance.project.id,
              "x-megon-session": input.sessionID,
              "x-megon-request": input.user.id,
              "x-megon-client": Flag.MEGON_CLIENT,
            }
          : {
