import type * as SDK from "@megon/sdk/v2"
...
export namespace ShareNext {
  ...
  const disabled = process.env["MEGON_DISABLE_SHARE"] === "true" || process.env["MEGON_DISABLE_SHARE"] === "1"
  ...
  export class Service extends Context.Service<Service, Interface>()("@megon/ShareNext") {}
