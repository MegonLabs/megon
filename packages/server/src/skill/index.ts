...
export namespace Skill {
  ...
  const MEGON_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.MEGON_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, MEGON_SKILL_PATTERN)
    }
  ...
  export class Service extends Context.Service<Service, Interface>()("@megon/Skill") {}
