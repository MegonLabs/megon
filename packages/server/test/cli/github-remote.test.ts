...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/megon.git")).toEqual({ owner: "sst", repo: "Megon" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/megon")).toEqual({ owner: "sst", repo: "Megon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/megon.git")).toEqual({ owner: "sst", repo: "Megon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/megon")).toEqual({ owner: "sst", repo: "Megon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/megon.git")).toEqual({ owner: "sst", repo: "Megon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/megon")).toEqual({ owner: "sst", repo: "Megon" })
})
