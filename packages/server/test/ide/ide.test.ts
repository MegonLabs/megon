...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MEGON_CALLER", () => {
    process.env["MEGON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MEGON_CALLER", () => {
    process.env["MEGON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MEGON_CALLER", () => {
    process.env["MEGON_CALLER"] = "unknown"
