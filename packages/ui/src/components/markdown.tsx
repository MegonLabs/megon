...
import { checksum } from "@megon/util/encode"
...
function setupCodeContextMenu(root: HTMLDivElement, getLabels: () => CopyLabels) {
  ...
  const handleContextMenu = (e: MouseEvent) => {
    ...
    const codeBlock = target.closest('[data-component="markdown-code"]')
    if (!codeBlock) return
    ...
    menu.setAttribute("data-component", "code-context-menu")
    ...
    copyItem.textContent = labels.copy
  ...
  const handleClickOutside = () => removeMenu()
...
export function Markdown(
  ...
  createEffect(() => {
    ...
    if (!contextMenuCleanup)
      contextMenuCleanup = setupCodeContextMenu(container, () => ({
        copy: i18n.t("ui.message.copy"),
        copied: i18n.t("ui.message.copied"),
      }))
  })
